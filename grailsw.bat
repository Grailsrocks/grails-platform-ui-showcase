...
set AGENT_STRING=-javaagent:grailsWrapper/springloaded-core-1.0.6.jar -noverify -Dspringloaded=%SPRINGLOADED_PARAMS%
...
set STARTER_CLASSPATH=grailsWrapper/grails-wrapper-runtime-2.1.1.jar;grailsWrapper;.
